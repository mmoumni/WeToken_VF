 ...
 * [Fourth_Bank_Transfer.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [Fourth_Bank_Transfer.newInstance] factory method to
 * create an instance of this fragment.
 */
class Fourth_Bank_Transfer : Fragment() {
    ...
    internal lateinit var textbanktransfer: TextView
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_fourth__bank__transfer, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        textbanktransfer = getView()!!.findViewById(R.id.textbanktransfer)

        btndone.typeface = tf3
        textviewwetoken.typeface = tf2
        text_euro.typeface = tf4
        textbanktransfer.typeface = tf3



        if (arguments?.getString("euro_amount")!=null){
            val text_euros = arguments?.getString("euro_amount")
    ...
    companion object {
         ...
         * @return A new instance of fragment Fourth_Bank_Transfer.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            Fourth_Bank_Transfer().apply {
