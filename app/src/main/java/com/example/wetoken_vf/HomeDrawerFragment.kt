 ...
 * [HomeDrawerFragment.OnFragmentInteractionListener] interface
...
class HomeDrawerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_home_drawer, container, false)
...
*/
    ...
    companion object {
         ...
         * @return A new instance of fragment HomeDrawerFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            HomeDrawerFragment().apply {
