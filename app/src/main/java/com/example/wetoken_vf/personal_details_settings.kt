 ...
 * [personal_details_settings.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [personal_details_settings.newInstance] factory method to
 * create an instance of this fragment.
 */
class personal_details_settings : Fragment() {
    ...
    override fun onCreateView(
       ...
       val view =  inflater.inflate(R.layout.fragment_personal_details_settings, container, false)



        val l_personaldetails =view.findViewById(R.id.retour) as ImageView
        l_personaldetails.setOnClickListener {
            ////////passer au fragment personal details

            val personaldetails = Settings()
        ...
        val l_settings = view.findViewById(R.id.l_settingpop) as LinearLayout
        l_settings.setOnClickListener(View.OnClickListener {
            ...
            val popupview = inflatr.inflate(R.layout.popup_persnal_details, null)
            ...
            if (context != null) {
                var dialogview: View = layoutInflater.inflate(R.layout.popup_persnal_details, null)
    ...
    companion object {
         ...
         * @return A new instance of fragment personal_details_settings.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            personal_details_settings().apply {
